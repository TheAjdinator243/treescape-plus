...
export const ar: Dictionary = {
  site: {
    ...
    description:
      'اسمك هنا فيلا تحيط بها الغابة — هدوء وطبيعة وكل وسائل الراحة المنزلية. تحقّق من المواعيد المتاحة واحجز عبر الإنترنت.',
    keywords: [
      'اسمك هنا',
      'فيلا',
      'بيت عطلات',
  ...
  about: {
    heading: 'أهلًا بك في اسمك هنا',
    lead: 'منزل مختبئ بين الأشجار، قريب بما يكفي للوصول إليه بسهولة، وبعيد بما يكفي لترتاح أخيرًا.',
    body: [
      'اسمك هنا فيلا عائلية تحيط بها أشجار الغابة العالية، ولها شرفة واسعة تطل على الوادي. في الداخل كل ما تحتاجه لإقامة طويلة — مطبخ مجهّز بالكامل، وغرفة معيشة دافئة بمدفأة، وغرف نوم تنام فيها فعلًا.',
    ...
    imageAlt: 'فيلا اسمك هنا من الخارج',
    stats: {
      guests: 'ضيوف',
      bedrooms: 'غرفتا نوم',
      bathrooms: 'حمّامان',
  ...
  location: {
    ...
    mapTitle: 'خريطة موقع فيلا اسمك هنا',
  ...
  notFound: {
    ...
    lead: 'ربما انتهت صلاحية الرابط أو كُتب بشكل خاطئ. إذا كنت تبحث عن حجزك، فتحقّق من العنوان في البريد الذي وصلك — أو اتصل بنا لنجده معًا.',
  ...
  admin: {
    ...
    overview: {
      moneyHeading: 'Money',
      moneyLead:
        'Only confirmed bookings count. A request still waiting on you is not money yet, and dates you closed for yourself are not a guest.',
      earnedThisMonth: 'This month',
      earnedThisYear: 'This year',
      earnedAllTime: 'All time',
      upcoming: 'Still to come',
      upcomingHint: 'Confirmed, but the stay has not started yet.',
      confirmed: 'Confirmed bookings',
      pending: 'Waiting on you',
      pendingHint: 'These hold their dates on a timer.',
      conversion: 'Requests confirmed',
      conversionHint: 'Of every request a guest sent.',
      occupancy: 'Next 90 days booked',
      occupancyHint: 'Share of the next 90 days already taken.',
      monthlyHeading: 'Earned by month',
      monthlyLead:
        'A booking counts in the month the stay begins, not the month it was made — this is when the house was working.',
      averagesHeading: 'Averages',
      nightsSold: 'Days sold',
      averageStay: 'Average stay',
      averageStayHint: 'In days.',
      averageNightly: 'Average per day',
      averageBooking: 'Average booking',
      trafficHeading: 'Visitors',
      trafficLead:
        'Counted without cookies and without following anyone over time, so no consent banner is needed. Someone who opens the site twice in one day counts once.',
      visitorsToday: 'Today',
      visitors30: 'Last 30 days',
      visitors365: 'Last 12 months',
      viewsCount: (n) => `${n} page ${n === 1 ? 'view' : 'views'}`,
      breakdownHeading: 'Who is coming',
      byLanguage: 'Language',
      byDevice: 'Device',
      bySource: 'Came from',
      noSources: 'Nobody arrived through a link from another site yet.',
      deviceNames: { phone: 'Phone', tablet: 'Tablet', desktop: 'Computer' },
    },
    tabRequests: 'الطلبات',
